...
urlpatterns = patterns('',
    ...
    url(r'^$', login, {'template_name': 'home.html'}),
    ...
    url(r'^addfreestyle/$', views.addfreestyle),
    url(r'^delete/(?P<foodlogid>\d+)/$', views.deletefoodlog, name='foodlog-delete'),
    url(r'^viewitem/(?P<itemid>\d+)/$', views.viewitem, name='item-view'),
    url(r'^updateportion/(?P<foodlogid>\d+)/(?P<portion>\d+)/$', views.updateportion, name='portion-update'),
